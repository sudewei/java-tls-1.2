...
public class Client {
    ...
    public void connectSecured(String serverAddress, int port) throws IOException {
        ...
        ConnectionState currentConnState = new ConnectionState(ConnectionEnd.CLIENT);
        ConnectionState nextConnState = new ConnectionState(ConnectionEnd.CLIENT);
...
//        ChannelWriter cw = ChannelWriter.get(sc, sndBuf);
        ...
        try {
            ...
            // inform the update layer to start encrypting and decrypting messages
            ...
            // ideally, since we have updated the securityparameters, the record layer should encrypt this for us
